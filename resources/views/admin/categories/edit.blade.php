...
<div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <h1 class="text-3xl font-bold text-gray-900 mb-8">Chỉnh sửa danh mục</h1>
    ...
    <form action="{{ route('admin.categories.update', $category) }}" method="POST" class="bg-white shadow rounded-lg p-6">
        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <input type="text" name="icon" value="{{ old('icon', $category->icon) }}" placeholder="fas fa-briefcase"
                       class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
